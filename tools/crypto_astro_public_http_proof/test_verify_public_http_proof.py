...
class PublicHttpProofTests(unittest.TestCase):
    ...
    def test_bhrigu_form_requires_canonical_dialogue_gateway(self) -> None:
        good = mod.FetchResult("https://example.test", "https://example.test", 200, [], "text/html", b'<title>BTC Field Read</title><aside class="heroQuestionCard heroDialogueGateway"><a href="/crypto-astro/btc/clean-chat?lang=en">Open BTC Field</a></aside>', {})
        ...
        stale_copy_only = mod.FetchResult("https://example.test", "https://example.test", 200, [], "text/html", b'<title>BTC Field Read</title><a href="/crypto-astro/btc/clean-chat?lang=en">Start free dialogue</a>', {})
        with self.assertRaises(mod.ProofFailure) as ctx:
